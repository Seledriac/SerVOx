...
public class ChooseCharacter implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        persos = CharacterHandler.listCharacters(1000);
        if(persos.size() > 0) {
    ...
    private void afficherPerso() {
        if(persos.size() > 0) {
            ...
            niveau_perso.setText("Niveau " + String.valueOf(perso.getLevel()));
            vie_perso.setText("Vie : " + String.valueOf(perso.getHealth()));
            mana_perso.setText("Mana : " + String.valueOf(perso.getMana()));
        }
    }
